...
{
    /// <summary>
    /// A simple interface that allows for reading or manipulating mail messages before and after transfer.
    /// </summary>
    public interface IMailInterceptor
    {
        ...
        /// </summary>
        /// <param name="context">
        /// A simple context containing the mail and a boolean value that can be toggled to prevent this mail from being sent.
        /// </param>
